...
const server = http.createServer(async (req, res) => {
  ...
  if (pathname === '/') {
    ...
    const bicycle = bicycles.find((data) => data.id === id);
    ...
    res.end(`<div style="display: flex; height: 1080px; align-items: center; justify-content: center">
    <h1 style="font-size: 72px">404 Page Not Found!</h1>
  </div>`);
  }
});
